...
It receives sanitized read-progress events from Mutsuki Kavita diagnostics and from the separate
Mutsuki Progress Bridge tracker/provider, then displays them locally.
